...
const WORD_PAIRS = {
  ...
  popculture: [
    ...
    ["Cyprien", "Natoo"],
    ["Tibo InShape", "Michou"],
    ["Lena Situations", "Léna Mahfouf"],
    ["Booder", "Malik Bentalha"]
  ...
  maroc: [
    ...
    ["mrouzia", "tangia"],
    ["seffa", "mhencha"],
    ["kaab el ghzal", "ghoriba"],
    ["bghrir", "harcha"],
    ["amlou", "smen"],
    ["argan", "olive"],
    ["Meknès", "Ouarzazate"],
    ["Jemaa el-Fna", "Hassan II"],
    ["Sahara", "Merzouga"],
    ["Ifrane", "Azrou"],
    ["gnawa", "chaabi"],
    ["Saad Lamjarred", "Douzi"],
    ["RedOne", "ElGrande Toto"],
    ["henné", "khôl"],
    ["wallah", "inshallah"]
  ]
};
